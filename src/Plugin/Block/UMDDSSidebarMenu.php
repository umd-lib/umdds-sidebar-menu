...
namespace Drupal\umdds_sidebar_menu\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "umdds_sidebar_menu",
 *   admin_label = @Translation("UMDDS Sidebar Menu Block")
 * )
 */
class UMDDSSidebarMenu extends BlockBase {
